...
public partial class MathsDivision : ContentPage
{
    ...
    private void GenerateRandomProblem()
    {
        ...
        int multiple = new Random().Next(1, 11); // Generate a random multiplier from 1 to 10
        int num2 = num1 * multiple;

        int correctAnswer = num2 / num1;

        problemLabel.Text = $" {num2} / {num1} = ?";
